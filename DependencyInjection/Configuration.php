            ...
            ->children()
                ->arrayNode('templates')
                        ...
                        ->children()
                            ...
                            ->scalarNode('rz_list_table_footer_batch')->defaultValue('RzAdminBundle:CRUD:list_table_footer_batch.html.twig')->cannotBeEmpty()->end()
                            ->scalarNode('rz_list_table_footer_download')->defaultValue('RzAdminBundle:CRUD:list_table_footer_download.html.twig')->cannotBeEmpty()->end()
                            ->scalarNode('rz_list_table_footer_pager')->defaultValue('RzAdminBundle:CRUD:list_table_footer_pager.html.twig')->cannotBeEmpty()->end()
                            ->scalarNode('rz_list_table_footer_per_page')->defaultValue('RzAdminBundle:CRUD:list_table_footer_per_page.html.twig')->cannotBeEmpty()->end()
                        ->end()
                    ->end()
                ->end()
            ->end();
